...
@section('content')
    ...
    <ul>
        @forelse ($games as $game)
            <li>
                <a class="w-full my-3 border-2 border-black px-2 py-3 flex hover:scale-110 hover:shadow transition-all" href="{{ route('games.show', ['game' => $game]) }}">
                    ...
                    <div class="w-1/4 h-100 ml-auto -my-3 -mx-2 border-l-2 border-black px-2 py-3 flex-shrink-0 flex flex-col justify-center items-center">
